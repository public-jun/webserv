...
private:
    ...
    void                         initListeners();
    void initListeningSockets(int port, const server_config_vec& server_configs);
    void initListeningSocket(const server_config_vec& server_configs, std::string host,
                    int port);
