...
void ConfigParser::setupCgiExtensions(str_vec_itr it[2], LocationConfig &location_config) {
  str_vec_itr cgi_extensions = std::find(it[BEGIN], it[END], Config::DERECTIVE_NAMES.at(CGI));
